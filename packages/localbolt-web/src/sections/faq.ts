const faqs = [
  ...
  { q: 'How do I transfer files between iPhone and Android?', a: 'Open localbolt.app on both devices while they are on the same local network. They will discover each other automatically. Tap the device to connect, then send files directly between iPhone and Android from the browser.' },
