...
export const DeviceDiscovery = ({
  ...
  if (isConnected && connectedDevice) {
    ...
    return (
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between px-3.5 py-3 rounded-md border border-neon/20 bg-neon/[0.04] animate-fade-in">
          ...
          <Button
            ...
            className="shrink-0 ml-3 text-xs h-7 px-2.5 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/20 transition-colors"
          >
            Disconnect
          </Button>
        </div>
  ...
  return (
    <div className="space-y-2">
      ...
      {peers.length === 0 ? (
        <div className="flex items-center gap-2.5 py-3 px-3.5 rounded-md bg-white/[0.02] border border-white/5">
          ...
          {peers.map((peer) => {
            ...
            return (
              <button
                ...
                className={`
                  group flex items-center gap-2.5 px-3.5 py-2.5 rounded-md
                  border transition-all duration-200 text-left animate-fade-in
                  ${
                    isConnecting
                      ? "border-neon/30 bg-neon/[0.04]"
                      : "border-white/5 bg-white/[0.02] hover:border-neon/20 hover:bg-white/[0.04] active:scale-[0.98]"
                  }
                `}
              >
                <Icon
